...
public class DBUtil {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/servlet_blog?user=root&password=root&useUnicode=true&characterEncoding=UTF-8&useSSL=false";
     ...
     *      2.学了多线程之后，可能会采用双重校验锁的单例模式来创建DataSource
